...
# solves and returns path with bfs or dfs search
# alter bfs to dfs by .popleft() or .pop() in bfs/dfs search function
# solves 3x3 puzzles in 2-3 seconds
# solution path for 3x3 is very wrong. too short for bfs, too long for dfs.
